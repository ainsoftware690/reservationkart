...
export const FAQS = [
  ...
  // ============ SUPPORT ============
  {
    ...
    answer:   "We offer multiple support channels available 24/7: Phone (+1 888 478 6801), Live Chat on our website, Email (info@reservationkart.com), and WhatsApp. Average response time is under 2 minutes for chat and phone, and under 4 hours for email. Premium members get priority support.",
  },
  {
    id:       21,
    category: 'support',
  ...
  },
  {
    ...
    answer:   "Our 24/7 emergency hotline (+1 888 478 6801) is available for urgent issues like missed connections, sudden cancellations, lost documents, or medical emergencies abroad. We coordinate directly with airlines and partners worldwide to find the fastest resolution — even at 3 AM on holidays.",
  },
];