...
const TOPICS = [
  'New Booking', 'Existing Booking', 'Cancellation & Refund',
  'Baggage Inquiry', 'Payment Issue', 'Technical Support', 'Other',
];
    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="bg-gradient-to-br from-brand-dark to-blue-900 py-16 sm:py-24 text-white text-center">
        ...
        <p className="mt-3 text-white/80 text-lg max-w-xl mx-auto">
          Our expert travel team is available 24/7 — ready to assist with bookings, changes, or any travel emergency.
        </p>
      </div>
      ...
      <div className="container-custom py-12 sm:py-16">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 mb-12">
          {CONTACT_INFO.map(({ icon: Icon, title, desc, value, href, badge, badgeColor }) => (
            <a
              key={title}
              href={href}
            ...
            <div className="bg-white rounded-2xl shadow-sm p-6 sm:p-8 border border-gray-100">
              {submitted ? (
                <div className="text-center py-8">
                  ...
                  <h3 className="mt-4 text-2xl font-bold text-brand-dark">Message Sent!</h3>
                  <p className="mt-2 text-gray-600">
                    We'll get back to you at <strong>{form.email}</strong> within 4 hours.
                  </p>
                  <button
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                      <Field label="Full Name" error={errors.name} required>
                        <input value={form.name} onChange={(e) => update('name', e.target.value)}
                          placeholder="John Doe" className={input(errors.name)} />
                      </Field>
          ...
          <div className="lg:col-span-5 space-y-4">
            ...
            <div className="bg-white rounded-2xl shadow-sm p-6 border border-gray-100">
              ...
              <div className="space-y-3">
                {[
                  ...
                  <div key={item.day} className="flex justify-between text-sm py-2 border-b border-gray-100 last:border-0">
                    <span className="font-semibold text-brand-dark">{item.day}</span>
            ...
            <div className="bg-white rounded-2xl shadow-sm p-6 border border-gray-100">
              ...
              <div className="space-y-4">
                {[
                  { city: 'New York', flag: '🇺🇸', addr: '350 Fifth Avenue, NY 10118', primary: true },
                  { city: 'Dubai',    flag: '🇦🇪', addr: 'DIFC, Sheikh Zayed Road'   },
                  ...
                  <div key={o.city} className="flex items-start gap-3">
                    ...
                    <div>
                      <div className="font-bold text-brand-dark text-sm flex items-center gap-2">
                        {o.city}
                        {o.primary && <span className="text-xs bg-brand-orange-100 text-brand-orange-700 px-2 py-0.5 rounded-full font-semibold">HQ</span>}
                      </div>
                      <div className="text-xs text-gray-500 mt-0.5">{o.addr}</div>
                    </div>
                  </div>
                ))}
              </div>
            ...
            <div className="bg-red-50 border border-red-200 rounded-2xl p-5">
              <h3 className="font-bold text-red-800 mb-2">🚨 Travel Emergency?</h3>
              <p className="text-sm text-red-700 mb-3">
                Missed connection, lost passport, medical emergency? Our emergency team is ready.
              </p>
...
const input = (err) =>
  `w-full px-4 py-3 rounded-xl border-2 bg-white focus:outline-none transition-all text-base ${
    err ? 'border-red-300 focus:border-red-500' : 'border-gray-200 focus:border-brand-orange-500'
  }`;