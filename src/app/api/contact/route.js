...
export async function POST(request) {
  try {
    ...
    return NextResponse.json(
      {
        error:   'Failed to send message. Please call +1 888 478 6801 or try again.',
      ...
      <table width="600" cellpadding="0" cellspacing="0" style="background:#ffffff;border-radius:16px;overflow:hidden;box-shadow:0 4px 20px rgba(0,0,0,0.08);">
            ...
            <tr><td style="padding:12px;background:#FFF4ED;border-radius:12px;">
              <table width="100%" cellpadding="0" cellspacing="0">
                <tr>
                  ...
                  <td align="right">
                    <a href="tel:+1 888 478 6801" style="background:#F26522;color:#ffffff;text-decoration:none;padding:10px 16px;border-radius:8px;font-weight:700;font-size:13px;white-space:nowrap;">
                      Call Now
                    </a>
                  </td>
                </tr>
        ...
        <tr><td style="background:#1A1A1A;padding:24px 40px;text-align:center;color:#888;font-size:13px;">
          ...
          <p style="margin:16px 0 0;font-size:11px;opacity:0.6;">
            3718 Gwynn Oak Ave, Gwynn Oak, MD, 21207<br>
            +1 888 478 6801 • info@reservationkart.com
          </p>
        </td></tr>
